...
/*despite of the fact vertices are set from mathematical point of view we keep them as vector becasue
 * we want to keep and use nice mathematical features of vector , mainly iteration.
 */
